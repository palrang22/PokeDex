//
//  PokemonTypeTranslate.swift
//  PokeDex
//
//  Created by 김승희 on 8/8/24.
//

import Foundation

enum PokemonTypeTranslate: String, CaseIterable, Codable {
    case normal
    case fire
    case water
    case electric
    ...
    static func getKoreanType(for englishType: String) -> String {
        return PokemonTypeTranslate(rawValue: englishType.lowercased())?.displayName ?? englishType
    }
}
